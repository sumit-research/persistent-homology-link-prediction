...
def main():
	...
	if(os.path.exists("/Users/admin/Desktop/Project/files/outputs/removed_edge_" + str(hop)) == False):
		os.system("mkdir /Users/admin/Desktop/Project/files/outputs/removed_edge_" + str(hop))
	...
	dumped_file = "/Users/admin/Desktop/Project/files/outputs/dumped_copy.txt"
	# os.system("/Users/admin/Desktop/Project/code/src_v2/johnson --dump_pairs " + data_file + " /Users/admin/Desktop/Project/files/outputs/removed_edge_" + str(hop) + "/global.txt /Users/admin/Desktop/Project/files/outputs/removed_edge_" + str(hop) + "/global_sparse.txt" )
	...
	for edge in random_edges:
		...
		for node_b in nodes:
			...
			dgm1_file = "/Users/admin/Desktop/Project/files/outputs/removed_edge_" + str(hop) + "/dipha_" + str(node_a)
			dgm2_file = "/Users/admin/Desktop/Project/files/outputs/removed_edge_" + str(hop) + "/dipha_" + str(node_b)
			dgmCombine_file = "/Users/admin/Desktop/Project/files/outputs/removed_edge_" + str(hop) + "/dipha_" + str(node_a) + "_" + str(node_b)
			dgmComplete_file = "/Users/admin/Desktop/Project/files/outputs/removed_edge_" + str(hop) + "/dipha_complete_" + str(node_a) + "_" + str(node_b)
			...
			in_file = "/Users/admin/Desktop/Project/files/outputs/removed_edge_" + str(hop) + "/apsp_complete_full_" + str(node_a) + "_" + str(node_b)
			f = open(in_file, "rb")
			data_p = f.read()
