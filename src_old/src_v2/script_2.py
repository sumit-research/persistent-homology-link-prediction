...
def main():
	...
	if(os.path.exists("/Users/admin/Desktop/Project/files/outputs/cora/removed_edge_" + str(hop)) == False):
		os.system("mkdir /Users/admin/Desktop/Project/files/outputs/cora/removed_edge_" + str(hop))
	...
	dumped_file = "/Users/admin/Desktop/Project/files/outputs/cora/dumped_copy.txt"
	# os.system("/Users/admin/Desktop/Project/code/src_v2/johnson --dump_pairs " + data_file + " /Users/admin/Desktop/Project/files/outputs/cora/removed_edge_" + str(hop) + "/global.txt /Users/admin/Desktop/Project/files/outputs/cora/removed_edge_" + str(hop) + "/global_sparse.txt" )
	...
	for edge in random_edges:
		...
		removed_edge_data = "/Users/admin/Desktop/Project/files/data/modified_data.txt"
		...
		for node_b in nodes:
			...
			dgm1_file = "/Users/admin/Desktop/Project/files/outputs/cora/removed_edge_" + str(hop) + "/dipha_" + str(node_a)
			dgm2_file = "/Users/admin/Desktop/Project/files/outputs/cora/removed_edge_" + str(hop) + "/dipha_" + str(node_b)
			dgmCombine_file = "/Users/admin/Desktop/Project/files/outputs/cora/removed_edge_" + str(hop) + "/dipha_" + str(node_a) + "_" + str(node_b)
			dgmComplete_file = "/Users/admin/Desktop/Project/files/outputs/cora/removed_edge_" + str(hop) + "/dipha_complete_" + str(node_a) + "_" + str(node_b)

			# obtain persistence diagrams for node_a, node_b and combined

			os.system("python3 /Users/admin/Desktop/Project/code/src_v2/get_persDiag.py --remove " + removed_edge_data + " " + str(node_a) + " " + str(hop))
			os.system("python3 /Users/admin/Desktop/Project/code/src_v2/get_persDiag.py --remove " + removed_edge_data + " " + str(node_b) + " " + str(hop))

			os.system("python3 /Users/admin/Desktop/Project/code/src_v2/get_persDiag.py --remove " + removed_edge_data + " " + str(node_a) + " " + str(node_b) + " " + str(hop))

			# get persistence diagram for complete graph
			in_file = "/Users/admin/Desktop/Project/files/outputs/cora/removed_edge_" + str(hop) + "/apsp_complete_full_" + str(node_a) + "_" + str(node_b)
			f = open(in_file, "rb")
			data_p = f.read()
			...
			process_a_b = Popen(["/Users/admin/Desktop/Project/code/src_v2/baseline", removed_edge_data, "/Users/admin/Desktop/Project/code/src_v2/test.txt", str(node_a), str(node_b)], stdout=PIPE)
