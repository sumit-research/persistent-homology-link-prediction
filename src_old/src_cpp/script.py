...
def main():
	...
	for l in lines:
		...
		dgm1_file = "/home/deepak/Project/files/outputs/"+dataset_name+"/n_" + str(hop) + "/ripser_" + str(node_a) + ".txt"
		dgm2_file = "/home/deepak/Project/files/outputs/"+dataset_name+"/n_" + str(hop) + "/ripser_" + str(node_b) + ".txt"
		dgmCombine_file = "/home/deepak/Project/files/outputs/"+dataset_name+"/n_" + str(hop) + "/ripser_" + str(node_a) + "_" + str(node_b) + ".txt"
		dgmComplete_file = "/home/deepak/Project/files/outputs/"+dataset_name+"/n_" + str(hop) + "/ripser_complete_" + str(node_a) + "_" + str(node_b) + ".txt"
