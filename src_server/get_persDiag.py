...
def main():
	...
	if(len(sys.argv) == 4):
		...
		if(remove):
			out_file = "/home/deepak/Project/files/outputs/removed_edge_" + str(hop) + "/dipha_" + str(nodes[0]) + "_" + str(nodes[1])
		...
		if(remove):
			out_file = "/home/deepak/Project/files/outputs/removed_edge_" + str(hop) + "/dipha_" + str(nodes[0])
